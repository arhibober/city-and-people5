...
class Treepress {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter('manage_family_custom_column', $plugin_admin, 'add_family_column_content', 10, 3);
		$this->loader->add_filter('plugin_action_links_treepress/treepress.php', $plugin_admin, 'treepress_paypal_link');
		// Add the fields to the "presenters" taxonomy, using our callback function
		$this->loader->add_action('family_edit_form_fields', $plugin_admin, 'family_custom_fields', 10, 2);
		// Save the changes made on the "presenters" taxonomy, using our callback function
		$this->loader->add_action('edited_family', $plugin_admin, 'save_family_custom_fields', 10, 2);
